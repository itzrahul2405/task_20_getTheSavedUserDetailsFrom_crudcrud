...
function registerUser(e){
    ...
    axios.post('https://crudcrud.com/api/7b7fb21a339b4a21bb9fb2adc2c94b39/bookingappointmentdata', myObj)
    .then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get('https://crudcrud.com/api/7b7fb21a339b4a21bb9fb2adc2c94b39/bookingappointmentdata')
    .then((response) => {
        console.log(response)
    ...
    // const data = axios.get('https://crudcrud.com/api/7b7fb21a339b4a21bb9fb2adc2c94b39/bookingappointmentdata')
    // .then((response) => {
    //     console.log(response)
    //     for(var i=0; i<response.data.length;i++){
    //         appendInList(response.data[i]); 
